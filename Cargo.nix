    ...
    crates = {
      ...
      "bencode" = rec {
        ...
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./bencode; }
          else ./bencode;
        authors = [
      ...
      "bin-str" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./bin-str; }
          else ./bin-str;
      ...
      "heap-dist-key" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./heap-dist-key; }
          else ./heap-dist-key;
      ...
      "iresult" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./iresult; }
          else ./iresult;
        authors = [
          "Stacey Ell <stacey.ell@gmail.com>"
        ];
      ...
      "magnetite-common" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-common; }
          else ./magnetite-common;
        authors = [
          "Stacey Ell <stacey.ell@gmail.com>"
        ];
        dependencies = [
      ...
      "magnetite-model" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-model; }
          else ./magnetite-model;
        dependencies = [
          {
            name = "bencode";
            packageId = "bencode";
      ...
      "magnetite-single" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-single; }
          else ./magnetite-single;
        dependencies = [
          {
            name = "bytes";
            packageId = "bytes";
      ...
      "magnetite-single-aggregator" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-single-aggregator; }
          else ./magnetite-single-aggregator;
        dependencies = [
          {
            name = "clap";
            packageId = "clap 4.4.18";
      ...
      "magnetite-single-api" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-single-api; }
          else ./magnetite-single-api;
        dependencies = [
          {
            name = "futures";
            packageId = "futures";
      ...
      "magnetite-single-wrapper" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-single-wrapper; }
          else ./magnetite-single-wrapper;
        dependencies = [
          {
            name = "clap";
            packageId = "clap 4.4.18";
      ...
      "magnetite-tracker" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-tracker; }
          else ./magnetite-tracker;
        dependencies = [
          {
            name = "bencode";
            packageId = "bencode";
      ...
      "magnetite-tracker-lib" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./magnetite-tracker/lib; }
          else ./magnetite-tracker/lib;
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "regex-automata 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "meta" "nfa-pikevm" "nfa-thompson" "std" "syntax" "unicode-bool" "unicode-case" "unicode-perl" "unicode-word-boundary" ];
      };
